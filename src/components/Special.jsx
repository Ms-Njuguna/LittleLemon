...
export default function Special({ description, title, price, foodItem }) {
    return(
        <div className="bg-[#EDEFEE] rounded-xl overflow-hidden shadow-sm">
            <img src={foodItem}
            alt={title}
