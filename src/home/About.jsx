        ...
        <section data-cy={dataCy} className="py-12 bg-[#EDEFEE]">
            <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row gap-10 items-center">
                ...
                <div className="flex-1 relative min-h-75 flex flex-col gap-4 md:block">
                    <img src={MA1} alt="Mario cooking in the kitchen" className="w-48 rounded-xl shadow-lg md:absolute md:top-0 md:left-0"/>
                    <img src={MA2} alt="Adrian planning marketing" className="w-48 rounded-xl shadow-lg md:absolute md:bottom-0 md:right-0"/>
                </div>
            </div>
        </section>
    )
