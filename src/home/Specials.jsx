...
export default function Specials({ "data-cy": dataCy }){
    return(
        <section data-cy={dataCy} className="py-12">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Special title="Lemon Dessert" price="$5.00" foodItem={LemonDessert} description="A zesty lemon dessert bursting with citrus flavor." />
                </div>
            </div>
        </section>
    )
